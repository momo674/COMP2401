...
void printStudentsForward(ArrayType*);
void printStudentsBackward(ArrayType*);
...
int main()
{
  ...
  printf("Print forward (1) or backward(2): ");
  scanf("%d", &choice);

  if (choice == 2) {
    printFunc = printStudentsBackward;
  }
  else {
    printFunc = printStudentsForward;
  }
...
void printStudentsForward(ArrayType *arr)
{
  printf("\n");
...
void printStudentsBackward(ArrayType *arr)
{
  printf("\n");
